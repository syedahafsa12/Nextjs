...
// import { FaGithub, FaDiscord, FaFacebook, FaTwitterSquare, FaLinkedin, FaYoutube, FaInstagram } from "react-icons/fa";
          ...
          <div className="row d-flex ">
            ...
            >
              ...
              <div className="card-body" style={{ marginBottom: "0px", marginTop: "0px" }}>
                ...
                <p className="card-text" style={{ marginBottom: '0px', marginTop: "0px" }}>An interactive game where players attempt to guess a randomly generated number.</p>
                <motion.div
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.2 }}
